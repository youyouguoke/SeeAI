...
export const spec: ConceptSpec = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { left: 'Waits for questions', right: 'Can be triggered by business events' },
      { left: 'Answers questions', right: 'Moves business work forward' },
      { left: 'Conversation context', right: 'Authorized enterprise information' },
      { left: 'Outputs suggestions', right: 'Can execute governed actions' },
      { left: 'No defined responsibility', right: 'Defined role and boundaries' },
    ],
