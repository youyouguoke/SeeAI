...
export const ontologyEn: OntologyContent = {
  ...
  definition: {
    ...
    db_body: 'Databases preserve facts, but cross-system business semantics are often not expressed as a unified layer.',
    onto_label: 'Enterprise Semantic Ontology',
    onto_body: 'Formalizes business semantics, constraints, and actions directly — providing structured business context for more reliable reasoning.',
    ...
    components: [
      {
        ...
        role: 'The “Nouns”',
        layer: 'static',
        body: 'Important things that exist in the business world.',
        example: 'Product, Part, Supplier, BOM',
      },
      {
        index: 'Primitive 02',
        icon: 'tune',
        ...
        role: 'The “States”',
        layer: 'static',
        body: 'Data describing an object’s state and facts.',
        example: 'Cost = $435.55, Status = Active',
      },
      {
        index: 'Primitive 03',
        icon: 'account_tree',
        name: 'Relationships',
        role: 'Structural Verbs',
        layer: 'static',
        body: 'Business-meaningful connections between objects.',
        example: 'contains, supplied by, depends on',
      },
      {
        index: 'Primitive 04',
        icon: 'bolt',
        ...
        layer: 'dynamic',
        body: 'Operations that can be performed in a business context, and the state changes they cause.',
        example: 'Approve, Schedule, Change Supplier',
      },
    ],
    contrast: {
      rel_label: 'RELATIONSHIP',
      rel_role: 'Structural Verbs',
      rel_from: 'Product A',
      rel_verb: '↓ contains',
      rel_to: 'Part 001',
      act_label: 'ACTION',
      act_role: 'Operational Verbs',
      act_from: 'Change Request',
      act_verb: '↓ approve',
      act_to: 'Approved',
    ...
    levels: [
      {
        ...
        body: 'SRM shows: Supplier X’s titanium bracket (Part 001) is +14 days late.',
      },
      {
        tag: 'L2',
        title: 'Part Shortage',
        body: 'Ontology: Product A’s BOM Rev 4.2 Requires Part 001 — a critical-path component.',
      },
      {
        tag: 'L3',
        title: 'Blast Radius',
        body: 'Traversing order relationships: a VIP customer order is hit — $50,000/day SLA penalty.',
      },
      {
        tag: 'L4',
        title: 'Executive Decision',
        body: 'Switch to a backup supplier / start a change request / expedite shipping — every option priced against the same relationship facts.',
      },
    ],
