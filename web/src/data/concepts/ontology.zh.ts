...
export const ontologyZh: OntologyContent = {
  ...
  definition: {
    ...
    db_label: '传统关系型数据库',
    db_body: '数据库保存事实，但跨系统的业务语义往往没有被表达为一个统一的层。',
    onto_label: '企业语义本体论',
    onto_body: '直接形式化业务语义、约束与动作——为更可靠的业务推理提供结构化的上下文。',
    ...
    levels: [
      {
        tag: 'L1',
        title: '供应商延迟',
        body: 'SRM 显示：供应商 X 的钛合金支架（零件 001）交付延迟 +14 天。',
      },
      {
        tag: 'L2',
        title: '零部件短缺',
        body: '本体关系：A 产品（SKU-7701）的物料清单 Rev 4.2 Requires 零件 001——该零件在关键路径上。',
      },
      {
        tag: 'L3',
        title: '影响范围',
        body: '沿订单关系遍历：VIP 客户订单命中，SLA 违约罚金 $50,000/天。',
      },
      {
        tag: 'L4',
        title: '管理层决策',
        body: '切换备用供应商 / 发起变更请求 / 加急运输——三个选项的代价都基于同一套关系事实计算。',
      },
    ],
